...
ALTER TABLE "workout_sets" ADD CONSTRAINT "workout_sets_template_id_exercise_templates_id_fkey" FOREIGN KEY ("template_id") REFERENCES "exercise_templates"("id") ON DELETE SET NULL;--> statement-breakpoint
ALTER TABLE "body_measurements" ADD CONSTRAINT "body_measurements_user_id_users_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE;